...
public class MeusDados {
    ...
    TreeMap<String, Professor> Professores = new TreeMap();
    ...
    class Turma {
        ...
        @Override
        public String toString(){
            String nomeTurma = Componentes.get(codigoComponente);
            return ano + "-" + nomeTurma;
        }
        
        @Override
        public int hashCode(){
            String nova = ano + codigoComponente + matriculaProfessor;
            return nova.hashCode();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if(obj instanceof MeusDados.Turma){
                MeusDados.Turma novoObj = (MeusDados.Turma) obj;
                
                resultado = this.ano.equals(novoObj.ano) && 
                            this.codigoComponente.equals(novoObj.codigoComponente) && 
                            this.matriculaProfessor.equals(novoObj.matriculaProfessor);
            }
            return resultado;
        }
    ...
    public MeusDados() {
        ...
        Professores.put("15768", new Professor ("15768", "Lúcia Melo") );
        Professores.put("13998", new Professor ("13998", "Elias Melo"));
        Professores.put("11234", new Professor ("11234", "Dinis Henriques"));
        Professores.put("10766", new Professor ("10766", "Hermínia Lázaro"));
